...
const connectionString = 'postgresql://postgres:postgres@localhost:5432/test'
...
fs.createReadStream('top_recommended_riskclass_high_prechurn_august_w1.csv')
    ...
    .on('end', () => {
        console.log(results);
        //save DataFile in DB
        const queryText = `INSERT INTO policies(uniqueId, broker,department,coverNumber,churnPropensityScore,riskClassOnPreChurnPolicies,
            businessDescription,versionNumber,effectiveDate,expiryDate,premium,totalIncome,stampDudy,fireServicesLevy,insureCharge,
